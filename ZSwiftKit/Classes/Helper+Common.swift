...
public extension Helper {
  ...
  static func Alert(view:UIViewController, title:String, message:String, confirmText: String) {
    Alert(view: view, title: title, message: message, confirmText: confirmText, doneCompletion: nil)
  }
  
  static func Alert(view:UIViewController, title:String, message:String, confirmText: String, doneCompletion:  ((UIAlertAction) -> Void)?) {
